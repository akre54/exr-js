...
import { Encoding, Image, SpecificChannels, Vec2 } from '../src/index.js'
...
test('write simple uncompressed EXR file', () => {
  ...
  console.log(
    `Wrote ${buffer.byteLength} bytes to test/outputs/test-output.exr`,
  )
  ...
  console.log(
    `Version: ${version & 0xff}, flags: 0x${(version >> 8).toString(16)}`,
  )
